import {insertUsuarioBasico} from "./supabase-consultas";
...
const RegisterForm = () => {
  ...
  const [recibirNotif, setRecibirNotif] = useState(false); // No se actualiza, queda pendiente
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validate()) {
      console.log('Datos válidos:', { email, password, country, recibirNotif });
      // Realizar inserción (retorna true si tuvo exito, y false en caso contrario)
      insertUsuarioBasico(email,password,country,false,setRegisterSucess);
    }
  };

  // Volver a la pagina de inicio al recibir un registro exito
  if (registerSucess == 2){
    setRegisterSucess(0); // Resetear estado
    navigate('/');
  }
        ...
        <Container maxWidth="xs" sx={{ mt: 8 }}>
          ...
          >
            ...
            <Box component="form" noValidate autoComplete="off" onSubmit={handleSubmit}>
              ...
              <p>{(registerSucess===1) ? "El email para este usuario ya está ocupado":""}</p>
              <Button
                fullWidth
                type="submit"
                variant="contained"
